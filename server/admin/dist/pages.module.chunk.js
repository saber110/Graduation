...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard_data_service__ = __webpack_require__("../../../../../src/app/pages/dashboard/data.service.ts");
...
var ChartjsMultipleXaxisComponent = (function () {
    function ChartjsMultipleXaxisComponent(theme, dataService) {
        var _this = this;
        this.theme = theme;
        this.dataService = dataService;
        this.dataService.getHeartRate().then(function (data) {
            _this.themeSubscription = _this.theme.getJsTheme().subscribe(function (config) {
...
ChartjsMultipleXaxisComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        providers: [__WEBPACK_IMPORTED_MODULE_2__dashboard_data_service__["a" /* DataService */]],
        selector: 'ngx-chartjs-multiple-xaxis',
        template: "\n    <chart type=\"line\" [data]=\"data\" [options]=\"options\"></chart>\n  ",
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__dashboard_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__dashboard_data_service__["a" /* DataService */]) === "function" && _b || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__status_card_status_card_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/status-card/status-card.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__contacts_contacts_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/contacts/contacts.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__rooms_rooms_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/rooms/rooms.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__rooms_room_selector_room_selector_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/rooms/room-selector/room-selector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__temperature_temperature_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/temperature/temperature.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__temperature_temperature_dragger_temperature_dragger_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/temperature/temperature-dragger/temperature-dragger.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__team_team_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/team/team.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__kitten_kitten_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/kitten/kitten.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__security_cameras_security_cameras_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/security-cameras/security-cameras.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__charts_chartjs_chartjs_multiple_xaxis_component__ = __webpack_require__("../../../../../src/app/pages/charts/chartjs/chartjs-multiple-xaxis.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
DashboardModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_11__temperature_temperature_dragger_temperature_dragger_component__["a" /* TemperatureDraggerComponent */],
            __WEBPACK_IMPORTED_MODULE_7__contacts_contacts_component__["a" /* ContactsComponent */],
            __WEBPACK_IMPORTED_MODULE_9__rooms_room_selector_room_selector_component__["a" /* RoomSelectorComponent */],
            __WEBPACK_IMPORTED_MODULE_10__temperature_temperature_component__["a" /* TemperatureComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_13__kitten_kitten_component__["a" /* KittenComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_22__charts_chartjs_chartjs_multiple_xaxis_component__["a" /* ChartjsMultipleXaxisComponent */],
            __WEBPACK_IMPORTED_MODULE_21__security_cameras_security_cameras_component__["a" /* SecurityCamerasComponent */],
...
var DataService = (function () {
    function DataService(http, app) {
        ...
        this.Host = "http://123.206.64.174:7777";
        this.RaspberryHost = "http://123.206.64.174:6565/";
        console.log(app.getUuid());
        this.uuid = app.getUuid();
    }
    DataService.prototype.SetMotor = function (CMD1) {
        if (CMD1 === void 0) { CMD1 = "11"; }
    ...
    DataService.prototype.getHeartRate = function () {
        return this.http.get(this.Host + '/api/heartRate/' + this.uuid)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    DataService.prototype.getSoup = function () {
        return this.http.get(this.Host + '/api/getsoup')
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    DataService.prototype.getWeather = function () {
...
DataService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* AppComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* AppComponent */]) === "function" && _b || Object])
], DataService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nebular_theme__ = __webpack_require__("../../../../@nebular/theme/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_service__ = __webpack_require__("../../../../../src/app/pages/dashboard/data.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ElectricityChartComponent = (function () {
    function ElectricityChartComponent(theme, dataService) {
        var _this = this;
        this.theme = theme;
        this.dataService = dataService;
        this.points = [];
        this.dataService.getHeartRate().then(function (data) {
            console.log(data);
            _this.points = [data[0][0], data[1][0], data[2][0], data[3][0], data[4][0], data[5][0], data[6][0], data[7][0], data[8][0], data[9][0]];
            _this.data = _this.points.map(function (p, index) { return ({
...
ElectricityChartComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__data_service__["a" /* DataService */]) === "function" && _b || Object])
...
var KittenComponent = (function () {
    function KittenComponent(themeService, dataService) {
        var _this = this;
        this.themeService = themeService;
        this.dataService = dataService;
        this.picture = "url('assets/images/kitten-{{currentTheme}}.png')";
        this.note = "这是一个测试消息";
        this.title = "每日一句";
        this.content = "这是一个测试消息";
        this.themeSubscription = this.themeService.getJsTheme().subscribe(function (theme) {
            _this.dataService.getSoup().then(function (data) {
                console.log(data);
                _this.content = data.content;
                _this.picture = data.fenxiang_img;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_service__ = __webpack_require__("../../../../../src/app/pages/dashboard/data.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StatusCardComponent = (function () {
    function StatusCardComponent(dataService) {
        this.dataService = dataService;
        this.on = true;
    }
    StatusCardComponent.prototype.click = function () {
        this.on = !this.on;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], StatusCardComponent.prototype, "cmd", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
...
var TemperatureComponent = (function () {
    function TemperatureComponent(theme, dataService) {
        var _this = this;
        this.theme = theme;
        this.dataService = dataService;
        this.temperature = 20;
    ...
    TemperatureComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getTemperature().then(function (data) {
            _this.temperature = data[0]['Temperature'];
        });
        this.dataService.getHumidity().then(function (data) {
            _this.humidity = data[0]['Humidity'];
        });
    };
...
var WeatherComponent = (function () {
    function WeatherComponent(dataService) {
        this.dataService = dataService;
        this.dataService.getWeather().then(function (data) {
            console.log(data);
        });
    }
